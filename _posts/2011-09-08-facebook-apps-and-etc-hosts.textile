...
A less painful way to fix this is to define an alias just for a subdomain, for example local.mywebapp.com, and use that instead of localhost when you're developing locally:
